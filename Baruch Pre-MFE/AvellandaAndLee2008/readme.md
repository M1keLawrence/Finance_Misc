...
1. expand implementation to include %var explained and ETF's 

2. Implement better modularization (and a class structure?) 
    - instead of parsing eigenvectors explicitly at the start of the backtest function, do that elsewhere (etc)

3. Expand data to include more stocks. Original paper used 1417, I use all stocks which were in the S&P500 since 2000. 
